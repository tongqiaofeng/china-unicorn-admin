    ...
    <el-container class="container">
      ...
      <el-aside class="aside" style="width:324px;height: 100%;position: fixed;left: 0;">
        <div class="aside-container">
          <div style="width: 180px;margin: 0 auto;padding-bottom: 10px;border-bottom:1px solid #f1f1f1;">
            <img src="../assets/imgs/lt.png" class="logoImg" />
            <p style="font-size: 21px;color: #fff;">China Unicom</p>
          </div>
          <ul class="person-ul">
      ...
      <el-container class="main" style="margin-left:324px;">
        ...
        <el-col :span="24" class="main-container">
          <!-- 开卡审核 -->
          <OpenCardAudit v-if="selected == 3"></OpenCardAudit>
          <!-- 提现审核 -->
          <WithdrawalAudit v-if="selected == 2"></WithdrawalAudit>
          <!-- 开卡记录 -->
          <OpenCardRecord v-if="selected == 1"></OpenCardRecord>
          <!-- 提现记录 -->
          <WithdrawalRecord v-if="selected == 4"></WithdrawalRecord>
        </el-col>
      </el-container>
    </el-container>
  </div>
...
<script>
  import OpenCardAudit from '../components/Open-card-audit.vue';
  import WithdrawalAudit from '../components/Withdrawal-audit.vue';
  import OpenCardRecord from '../components/Open-card-record.vue';
